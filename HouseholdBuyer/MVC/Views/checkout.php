...
<head>
	...
	<title>Dairy Direct - checkout page</title>
</head>
<body>
	...
	<div class="main">
		...
		<section class="checkout">
			<div class="title">
				...
				<h1>checkout summary</h1>
				<p>Derived from milk and produced in wide ranges of flavors, textures and forms by coagulation of the milk protein casein.
                </p>
            </div>
                <div class="row">
                	<form method="post">
                	...
                	<div class="summary">
                		...
                		<div class="grand-total"><span>total amount payable: </span>TK <?= $grand_total ?>/-</div>
                	</div>
			</div>
		</section>
